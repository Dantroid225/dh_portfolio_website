...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    {
      name: 'LinkedIn',
      url: 'https://linkedin.com/in/dadtroid',
      icon: (
        <svg className='w-5 h-5' fill='currentColor' viewBox='0 0 24 24'>
    ...
    {
      name: 'Twitter',
      url: 'https://twitter.com/dadtroid',
      icon: (
        <svg className='w-5 h-5' fill='currentColor' viewBox='0 0 24 24'>
    ...
    {
      name: 'Instagram',
      url: 'https://instagram.com/dadtroid',
      icon: (
        <svg className='w-5 h-5' fill='currentColor' viewBox='0 0 24 24'>
      ...
      <div className='container-custom section-padding'>
        ...
        <div className='border-t border-dark-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0'>
          <p className='text-gray-400 text-sm'>
            © {currentYear} Dadtroid. All rights reserved.
          </p>
